...
<head>
  ...
  <title>CHART - Demographics</title>
  <!-- MDB icon -->
...
<body class="fixed-sn" onload="loadPageFunction()">
  ...
  <div id="chartDemographics" style="display:none;">
      ...
      <ul class="custom-scrollbar black-text">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="my-2 text-left"><a class="collapsible-header waves-effect arrow-r side-nav-link active" href="../demographics"><i class="fas fa-user-circle"></i>Demographics</a>
            </li>
  ...
  <main class="main mx-5">
    ...
    <div class="row mb-3">
      <div class="col-12 mb-3">
          <div class="page-title" style="display: inline-block;">Demographics 
    ...
    <div class="card chart-card px-3">
