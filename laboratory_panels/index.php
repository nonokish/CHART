...
<head>
  ...
  <title>CHART - Laboratory Panels</title>
  <!-- MDB icon -->
...
<body class="fixed-sn" onload="loadPageFunction()">
  ...
  <div id="chartLabPanels" style="display:none;">
      ...
      <ul class="custom-scrollbar black-text">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="my-2 text-left"><a class="collapsible-header waves-effect arrow-r side-nav-link active" href="../laboratory_panels"><i class="fas fa-flask"></i> Laboratory Panels</a>
            </li>
...
<!-- jQuery -->
  ...
  <script>
    ...
    function showPage() {
      ...
      document.getElementById("chartLabPanels").style.display = "block";
    }
  </script>
