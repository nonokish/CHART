...
<head>
  ...
  <title>CHART - Prescription</title>
  <!-- MDB icon -->
...
<body class="fixed-sn" onload="loadPageFunction()">
  ...
  <div id="chartPrescription" style="display:none;">
      ...
      <ul class="custom-scrollbar black-text">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="my-2 text-left"><a class="collapsible-header waves-effect arrow-r side-nav-link active" href="../prescription"><i class="fas fa-file-prescription"></i> Prescription</a>
            </li>
  ...
  <main class="main mx-5">
    ...
    <div class="col-12 mb-3">
          <div class="page-title" style="display: inline-block;">Prescription
    ...
    <div class="col-12 mb-3">
      <ul class="nav nav-tabs nav-justified md-tabs chart-tabs" id="prescriptionTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="assessmentHistory-tab" data-toggle="tab" href="#assessmentHistory" role="tab" aria-controls="assessmentHistory"
            aria-selected="true">Assessment & History</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="HD-tab" data-toggle="tab" href="#HD" role="tab" aria-controls="HD"
            aria-selected="false">Dialysis Manage Order</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="homeMeds-tab" data-toggle="tab" href="#homeMeds" role="tab" aria-controls="homeMeds"
            aria-selected="false">Home Meds</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="HDMeds-tab" data-toggle="tab" href="#HDMeds" role="tab" aria-controls="HDMeds"
            aria-selected="false">HD Meds</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="labPanels-tab" data-toggle="tab" href="#labPanels" role="tab" aria-controls="labPanels"
            aria-selected="false">Lab Panels</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="treatments-tab" data-toggle="tab" href="#treatments" role="tab" aria-controls="treatments"
            aria-selected="false">Treatments</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="standingOrders-tab" data-toggle="tab" href="#standingOrders" role="tab" aria-controls="standingOrders"
            aria-selected="false">Standing Orders</a>
        </li>
      </ul>
      <div class="tab-content card pt-5" id="prescriptionTabContent">
        <div class="tab-pane fade show active" id="assessmentHistory" role="tabpanel" aria-labelledby="assessmentHistory-tab">
          <p>Assessment & History</p>
        </div>
        <div class="tab-pane fade" id="HD" role="tabpanel" aria-labelledby="HD-tab">
          <p>HD</p>
        </div>
        <div class="tab-pane fade" id="homeMeds" role="tabpanel" aria-labelledby="homeMeds-tab">
          <p>Home Meds</p>
        </div>
        <div class="tab-pane fade" id="HDMeds" role="tabpanel" aria-labelledby="HDMeds-tab">
          <p>HD Meds</p>
        </div>
        <div class="tab-pane fade" id="labPanels" role="tabpanel" aria-labelledby="labPanels-tab">
          <p>Lab Panels</p>
        </div>
...
<!-- jQuery -->
  ...
  <script>
    ...
    function showPage() {
      ...
      document.getElementById("chartPrescription").style.display = "block";
    }
  </script>
