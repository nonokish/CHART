...
<head>
  ...
  <title>CHART - Progress Notes</title>
  <!-- MDB icon -->
...
<body class="fixed-sn" onload="loadPageFunction()">
  ...
  <div id="chartProgressNotes" style="display:none;">
      ...
      <ul class="custom-scrollbar black-text">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="my-2 text-left"><a class="collapsible-header waves-effect arrow-r side-nav-link active" href="../progress_notes"><i class="fas fa-notes-medical"></i> Progress Notes</a>
  ...
  <main class="main mx-5">
    ...
    <div class="row mb-3">
      <div class="col-12 mb-3">
          <div class="page-title" style="display: inline-block;">Laboratory Panels
          </div>
...
<!-- jQuery -->
  ...
  <script>
    ...
    function showPage() {
      ...
      document.getElementById("chartProgressNotes").style.display = "block";
    }
  </script>
